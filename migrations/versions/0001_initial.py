...
def upgrade() -> None:
    ...
    op.create_index('ix_messages_project_channel_created', 'messages', ['project_id', 'channel_id', 'created_at'], unique=False)
    op.create_table('project_channels',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('project_id', sa.UUID(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['discord_guild_id'], ['discord_guilds.id'], ),
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], ),
    sa.PrimaryKeyConstraint('id'),
